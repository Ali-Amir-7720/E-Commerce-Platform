...
/**
 * CourierChat
 * Drop this in CourierDashboard to show all customer conversations.
 */
const CourierChat = () => {
    ...
    return (
        <div className="mt-8">
            <h3 className="text-sm font-black text-white/50 uppercase tracking-widest mb-4 flex items-center gap-2">
                <MessageCircle className="w-4 h-4" /> Customer Messages
            </h3>
                    ...
                    {conversations.map((conv, i) => (
                        <button key={i} onClick={() => setActiveChat(conv)}
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-cyan-400/60 truncate font-mono">{conv.title}</p>
